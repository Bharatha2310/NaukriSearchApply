...
public class SearchTestEngineer extends BaseClass {
	...
	public void searchDotNet() throws AWTException, InterruptedException
	{
	   ...
	   // wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//input[@placeholder='Enter your active Email ID / Username']")));
	    ...
	    Thread.sleep(3000);
	    driver.findElement(By.xpath("//input[@id='qsb-keyskill-sugg']")).sendKeys(profilesearch);
	    Thread.sleep(1000);
	    ...
	    Thread.sleep(3000);
	    if (jobprofile.contains("Test Engineer") || jobprofile.contains("QA") || jobprofile.contains("Manual") || jobprofile.contains("Test")|| jobprofile.contains("Engineer"))
	    {
